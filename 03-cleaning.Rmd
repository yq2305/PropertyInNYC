...
dat = bind_rows(
  preprocess(read_xlsx('rollingsales_manhattan.xlsx')),
  preprocess(read_xlsx('rollingsales_queens.xlsx')),
  preprocess(read_xlsx('rollingsales_bronx.xlsx')),
  preprocess(read_xlsx('rollingsales_brooklyn.xlsx')),
  preprocess(read_xlsx('rollingsales_statenisland.xlsx'))
  )%>%
