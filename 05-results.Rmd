...
annotate_figure(fig_1,
               bottom = text_grob('Figure 2: Sales by borough', hjust = 0.5, face = "italic", size = 25))
```
...
annotate_figure(fig_2,
               bottom = text_grob('Figure 3: Times series of sales by borough', hjust = 0.5, face = "italic", size = 25))
```
...
annotate_figure(fig_3,
               bottom = text_grob('Figure 4: Top 20 most expensive (left) and most popular (right) neighborhoods in NYC', hjust = 0.5, face = "italic", size = 20))
```
...
annotate_figure(fig_5,
               bottom = text_grob('Figure 6: Frequency of tax and building class change after sales (left); Sales price versus class change (right)', hjust = 0.5, face = "italic", size = 13))
```
...
fig_6 = ggpairs(dat, columns = c(7:11,15),
  ...
  labs(caption = 'Figure 7: Association between continuous variables and sales price') +
