...
map1 = nyc_zip_boundary%>%
  ...
  mutate(COVID_CASE_RATE = coalesce(COVID_CASE_RATE, 0))%>%
  ggplot()+
...
map4 = nyc_zip_boundary%>%
  ...
  #geom_sf_text(aes(label = ZIPCODE), colour = "white")
  #scale_fill_gradient(high = "#e34a33", low = "#fee8c8", guide = "colorbar",trans = 'log', breaks = c(8000, 2000, 1600, 1200,800, 400,0),labels = c(8000, 2000, 1600, 1200,800, 400,0))+
  scale_fill_binned(high = "#e34a33", low = "#fee8c8",breaks = c(9000, 2000, 1600, 1200, 800, 400, 0), trans = 'log')+
