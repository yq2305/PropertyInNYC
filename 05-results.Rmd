...
From figure 7(b), we observe that most days have fewer than 1,000 COVID-19 cases. To be more specific, 147 out of the 203 days in the record have lower or equal to 1,000 COVID-19 cases. Most days with relatively fewer COVID-19 cases (below 1,000) have between 50 to 100 cases of property sales. The sales count dots for days with relatively fewer COVID-19 cases are more widely spread on the sales count axis. Also, we observe a weak negative association between the daily COVID-19 case count and daily sales count as the days with more cases tend to have lower property transaction counts.
