...
map2 = nyc_zip_boundary%>%
  ...
  scale_fill_gradient(high = "#e34a33", low = "#fee8c8", guide = "colorbar")+
  ggtitle('Total sales count by zipcode')+
...
map3= nyc_zip_boundary%>%
  ...
  theme_bare+labs(fill = 'Total sales amount')+
    ggtitle('Total sales amount by zipcode')+
  ggrepel::geom_label_repel(
...
map4 = nyc_zip_boundary%>%
  ...
  ggrepel::geom_label_repel(
    ...
    colour = "magenta",
    segment.colour = "magenta")+
    ggtitle('Median unit sales price by zipcode')
...
fig8c = zipcode_dat%>%
  ...
  ggtitle('Median unit sales price vs. COVID-19 case count')+
  theme_regular
fig8_2= ggarrange(fig8a, fig8b, fig8c, nrow = 1, ncol = 3)
annotate_figure(fig8_2,
               bottom = text_grob('Figure 8(b):Association between property sales and COVID-19 case rate(out of 100,000) by zipcode', 
                                  hjust = 0.5, face = "italic", size = 20))
