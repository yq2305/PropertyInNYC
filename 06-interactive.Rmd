...
The current map is colored by the median unit price of each zip code. Ideally, the map should have multiple coloring options, but we were not able realize such a feature. 
  ...
  <script type="text/javascript" >
    ...
    info.update = function(props) {
      ...
      this._div.innerHTML = '<h4>NYC Poperty Sales Data</h4>' +  (props ?
        ...
        +'</b><br />' + 'Sales: ' + sales +'</b><br />' + 'Median price($): '+ mid +'</b><br />' + 'Total(MM): '+ total
